...
class MicroThinkClient:
    ...
    def generate(
        ...
        2. Calls the model and parses the structured response
        3. If expect_json=True, validates and retries up to 3 times on failure
        4. Returns only the final answer (thinking is stripped unless debug=True)
        ...
        system_prompt = build_system_prompt(behavior, expect_json)
